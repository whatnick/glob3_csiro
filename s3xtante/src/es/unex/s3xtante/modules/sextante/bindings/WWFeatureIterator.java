...
public class WWFeatureIterator
   ...
   private final Iterator<IGlobeFeature<IVector2<?>, GAxisAlignedRectangle>> _iterator;
   ...
   public WWFeatureIterator(final IGlobeFeatureCollection<IVector2<?>, GAxisAlignedRectangle, ?> features,
      ...
      _iterator = new FilterIterator(features.iterator(), predicates.toArray(new SextanteFilterPredicate[0]));
   ...
   public IFeature next() throws IteratorException {
      ...
      try {
         final IGlobeFeature<IVector2<?>, GAxisAlignedRectangle> globeFeature = _iterator.next();
