...
public class OOTemplateSample {
   ...
   public static class Customer {
      ...
      private final static String[] IMAGES = new String[] { "oosample/ciguena.png", "oosample/dragon.png", "oosample/human.png" };
   ...
   private static Collection<Customer> createCustomers() {
      ...
      customers.add(new Customer("El Nobel", new String[] { "Acá a la vuelta" }, -1000));
      customers.add(new Customer("Top Manta", new String[] {}, 0));
      customers.add(new Customer("El burguer", new String[] { "Dirección 1", "Dirección 2" }, -2568769));
