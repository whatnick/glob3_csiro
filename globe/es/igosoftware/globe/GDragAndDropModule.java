...
public class GDragAndDropModule
   ...
   public void initialize(final IGlobeApplication application) {
      ...
      final WorldWindowGLCanvas canvas = application.getWorldWindowGLCanvas();
   ...
   private boolean acceptDroppedFiles(final List<File> files) {
      ...
      for (final File file : files) {
         ...
         final IDropFileHandler selectedHandler = chooseOnlyOneHandler(file, selectedHandlers);
   ...
   private static class DropFileHandlerWrapper {
      ...
      private DropFileHandlerWrapper(final IGlobeApplication application,
      ...
      public String toString() {
         return _application.getTranslation(_handler.getDescription());
      }
   }


   private IDropFileHandler chooseOnlyOneHandler(final File file,
      ...
      final DropFileHandlerWrapper selectedHandler = (DropFileHandlerWrapper) JOptionPane.showInputDialog(application.getFrame(),
               application.getTranslation("Select an option for: " + file), application.getTranslation("Choose an option"),
               JOptionPane.PLAIN_MESSAGE, application.getIcon(GFileName.relative("add.png"), 32, 32), wrappers.toArray(), null);
