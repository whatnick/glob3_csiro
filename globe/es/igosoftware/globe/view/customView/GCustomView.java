...
public class GCustomView
   ...
   public void setHeading(final Angle newHeading) {
      ...
      this.heading = GCustomViewLimits.limitHeading(this.heading, this.getOrbitViewLimits());
   ...
   public void setPitch(final Angle newPitch) {
      ...
      this.pitch = GCustomViewLimits.limitPitch(this.pitch, this.getOrbitViewLimits());
      //resolveCollisionsWithPitch();
   }
