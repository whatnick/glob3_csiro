...
import es.igosoftware.experimental.gui.GDatosForTabla;
import es.igosoftware.experimental.gui.GDatosForTablaFactory;
...
public class GWMSDialog
   ...
   public GWMSDialog(final IGlobeApplication application) {


      super(application.getFrame(), "Web Map Service", true);
   ...
   private void createWMSDialog() {
      ...
      //-- used tabbed pane in order to be reading for adding new components
   ...
   private JDialog createServerDataDialog(final Container cont,
      ...
      final JDialog editDialog = new JDialog(_application.getFrame(), message, true);
