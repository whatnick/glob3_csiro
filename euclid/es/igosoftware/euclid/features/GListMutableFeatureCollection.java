...
>
         extends
            GMutableAbstract<GListMutableFeatureCollection<VectorT, FeatureGeometryT, FeatureBoundsT>>
         implements
            IGlobeMutableFeatureCollection<VectorT, FeatureGeometryT, FeatureBoundsT, GListMutableFeatureCollection<VectorT, FeatureGeometryT, FeatureBoundsT>> {


   private final GProjection                                                         _projection;
   private final ArrayList<GField>                                                   _fields;
   private final ArrayList<IGlobeFeature<VectorT, FeatureGeometryT, FeatureBoundsT>> _features;
   ...
   public GListMutableFeatureCollection(final GProjection projection,
      ...
      _features = (features == null) ? new ArrayList<IGlobeFeature<VectorT, FeatureGeometryT, FeatureBoundsT>>(0)
                                    : new ArrayList<IGlobeFeature<VectorT, FeatureGeometryT, FeatureBoundsT>>(features);
   ...
   public IGlobeFeature<VectorT, FeatureGeometryT, FeatureBoundsT> remove(final long index) {
      ...
      final IGlobeFeature<VectorT, FeatureGeometryT, FeatureBoundsT> result = _features.remove(toInt(index));
      if (result != null) {
         changed();
      }
      return result;
