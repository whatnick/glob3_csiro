...
public class GConditionalExpression<GeometryT extends IGeometry2D, ResultT>
   ...
   public void preRender(final IVectorI2 renderExtent,
      ...
      _condition.preRender(renderExtent, projectionTool, viewport, renderingStyle, drawer);
      _trueExpression.preRender(renderExtent, projectionTool, viewport, renderingStyle, drawer);
      _falseExpression.preRender(renderExtent, projectionTool, viewport, renderingStyle, drawer);
   }
