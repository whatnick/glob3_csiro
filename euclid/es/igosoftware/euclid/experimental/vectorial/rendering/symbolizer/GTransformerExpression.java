...
public class GTransformerExpression<GeometryT extends IGeometry2D, ExpressionResultT, ResultT>
   ...
   public void preRender(final IVectorI2 renderExtent,
      ...
      _expression.preRender(renderExtent, projectionTool, viewport, renderingStyle, drawer);
   }
   ...
   public void postRender(final IVectorI2 renderExtent,
                          ...
                          final ISymbolizer2D renderingStyle,
                          final IVectorial2DDrawer drawer) {
      _expression.postRender(renderExtent, projectionTool, viewport, renderingStyle, drawer);
   }
