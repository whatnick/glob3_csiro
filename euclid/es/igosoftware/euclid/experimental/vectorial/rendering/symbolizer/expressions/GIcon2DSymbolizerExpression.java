...
public class GIcon2DSymbolizerExpression
   ...
   public void preRender(final IVectorI2 renderExtent,
      ...
      _iconExpression.preRender(renderExtent, projectionTool, viewport, renderingStyle, drawer);
   ...
   public void postRender(final IVectorI2 renderExtent,
                          ...
                          final ISymbolizer2D renderingStyle,
                          final IVectorial2DDrawer drawer) {
      _iconExpression.postRender(renderExtent, projectionTool, viewport, renderingStyle, drawer);
