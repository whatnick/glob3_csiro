...
public class NonTreeDasometricVariableFilterDialog extends FilterDialog {
	...
	public NonTreeDasometricVariableFilterDialog(){
	...
	private void initGUI(){
		...
		TableLayout thisLayout = new TableLayout(new double[][] {{TableLayout.FILL, TableLayout.FILL, TableLayout.FILL, TableLayout.FILL, TableLayout.FILL, TableLayout.FILL}, {TableLayout.FILL, TableLayout.MINIMUM, TableLayout.MINIMUM, TableLayout.MINIMUM, TableLayout.FILL}});
		...
		}
		{
			ComboBoxModel jComboBoxParameterModel =
				new DefaultComboBoxModel(NonTreeDasocraticVariableFilter.VARIABLES);
		...
		}
		{
			ComboBoxModel jComboBoxCriteriaModel =
				new DefaultComboBoxModel(NonTreeDasocraticVariableFilter.CRITERIA);
	...
	protected boolean checkValuesAndSetFilter() {
		...
		try{
			m_Filter = new NonTreeDasocraticVariableFilter(
