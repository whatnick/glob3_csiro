...
public class DatabaseFilesSelectionPanel extends BaseWizardPanel{
	...
	public DatabaseFilesSelectionPanel(IFN3Panel panel){
		...
		try {
			{
				...
				}
				{
					...
					jLabelText.setText("Seleccione los archivos del IFN3 a utilizar (datestXX.dbf)");
	...
	private void addFile() {
        ...
        if (iReturn == JFileChooser.APPROVE_OPTION) {
            ...
            for (i = 0; i < files.length; i++){
            	if (files[i].getName().toLowerCase().endsWith(".dbf")){
