...
public class IFN3Extension extends AbstractMeigasExtension {

	public String getName(){

		return "Rellenar con datos del IFN3";
	...
	public Icon getIcon() {
		...
		Icon icon = new ImageIcon(getClass().getClassLoader()
				.getResource("images/importIFN3.gif"));
		return icon;
	}

	public void execute(MeigasPanel meigasPanel) {

		IFN3Panel dialog = new IFN3Panel(meigasPanel);
